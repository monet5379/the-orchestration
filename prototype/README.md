...
공유용 패치노트 → [`../docs/patch-note/0.1.30.md`](../docs/patch-note/0.1.30.md)

---

## 지금 할 수 있는 것

- 가위·바위·보 + **60초** 패 선택 · **15초** **ADJUST**(유지 / 변경 / 페이크 · **한 번 확정**)
...
- 마스크 POV · **POV 안 HUD**(턴·페널티·수정·페이크·가면) · SFX(상대 페이크·변경·SELECT)
